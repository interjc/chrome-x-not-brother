...
5. Update the matching files under `docs/` and, when counterparts exist, `docs/en/` or root `README.en.md`, plus these skill references, when behavior or workflow changes.
