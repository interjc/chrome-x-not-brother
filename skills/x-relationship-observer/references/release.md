...
3. Update user, maintenance, privacy, and release documentation where necessary.
4. Load nvm and run:
...
Use `docs/store-listing.md` for ready-to-paste English, Japanese, and Simplified Chinese listing copy, release notes, permission justifications, the privacy-practices worksheet, and reviewer instructions. Reconcile every claim with the current code before submission.
