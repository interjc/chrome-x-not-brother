...
- `src/content/`: inspect already-rendered X DOM, normalize evidence, discard internal unknown, inject badges, and send known observation drafts.
...
- `src/domain/`: types, relationship resolution, data merge semantics, import, and export.
...
- `src/ui/`: side panel, dashboard, shared components, and presentation.
