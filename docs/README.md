...
面向使用者的说明在仓库根目录 [README.md](../README.md)，其中「自定义拦截规则」一节说明界面编写、导入导出和公开托管。英文从 [README.en.md](../README.en.md) 进入，对应开发者文档在 [docs/en/](en/README.md)。本目录保存产品边界、架构、开发、测试、发布和商店文案。给编码代理的入口是 [AGENTS.md](../AGENTS.md) 与 [项目 skill](../skills/x-relationship-observer/SKILL.md)。阅读或改写导出的规则 JSON 用 [x-not-brother-rules](../skills/x-not-brother-rules/SKILL.md)。
...
| [国际化设计](localization.md) · [EN](en/localization.md) | 中英日自动切换、词库边界、扩展语言、仓库文档语言与商店本地化 |
| [技术架构](architecture.md) · [EN](en/architecture.md) | 运行时数据流、模块边界和安全约束 |
| [数据模型](data-model.md) | users、observations、合并和迁移规则 |
| [自定义拦截规则](filter-rules.md) · [EN](en/filter-rules.md) | filter-rules JSON v1、匹配语义、限制与导入权限 |
| [开发指南](development.md) · [EN](en/development.md) | nvm、安装、构建、目录与日常流程 |
...
| [使用条款](../terms/terms.md) | 独立软件声明、使用范围、识别限制与免责；源稿中英对照 |
| [首次上架准备](deploy.md) | 第一次发布：已完成项、截图做法、Dashboard 逐步操作 |
| [发布指南](release.md) · [EN](en/release.md) | 版本、检查、打包、商店准备和回滚 |
